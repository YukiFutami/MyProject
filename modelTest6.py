...
model = Sequential([
    ...
    Conv2DTranspose(128, (3, 3), strides=(2, 2), padding='same', activation='relu'),  # 128x128 -> 256x256
    Conv2DTranspose(64, (3, 3), strides=(2, 2), padding='same', activation='relu'),   # 256x256 -> 256x256 (変わらない)
    
    # 最終的に256x256に縮小
    Conv2DTranspose(1, (3, 3), strides=(2, 2), padding='same', activation='sigmoid')  # 256x256 -> 256x256
])
